...
def knapsack():
    ...
    temperatures_list = [5, 10, 300]

    for prob, temperature in zip(problems, temperatures_list):
        rhc = mlrose.SARunner(problem=prob,
        ...
        print(best_runs)
        best_temperature = best_runs[best_runs['Iteration'] == best_runs['Iteration'].min()].iloc[0]
        best_curve = df_run_curves[df_run_curves['Temperature'] == best_temperature['Temperature']]
